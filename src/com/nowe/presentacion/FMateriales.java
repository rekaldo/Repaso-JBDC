...
public class FMateriales extends javax.swing.JFrame {
    ...
    private void btnAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaActionPerformed
        ...
        try {
            ...
            if (exito) {
                lblResultado.setText("Se dió de alta su material.");
            } else {
                lblResultado.setText("Error en datos, no se ha podido dar de alta el material.");
            }

            // 4. Mostrar el mensaje de exito o fracaso en el formulario
        } catch (ClassNotFoundException | SQLException ex) {
            System.out.println(ex.toString());
            lblResultado.setText("Error en BBDD, no se ha podido dar de alta el material.");
        }
